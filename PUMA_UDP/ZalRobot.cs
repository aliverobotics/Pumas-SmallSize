...
namespace ZalSystem
{
	...
	{
        //used now for onboard intelligence*******************************
		public float Dist2tgt;			//Distance between ball & robo
		public float Ang2tgt;			//Angle to watch in front the ball
        public float Angle;             //Angle that actually watches the robot
		public float X;					//X Position
		public float Y;					//Y Position
        public int MyIdNum;			//Robots identification number
        /*****************************************************************/
		...
		private const string SHOOTON	= "FF00000000";
		private const string SHOOTOFF	= "FF00000001";
		...
		{
			//Serial port 
			this.sPort = new SerialPort(9600, 8, 0, 1);
			...
			turnPulsesChart = new int[]{0, 15, 30, 60, 80, 100, 125, 150, 175, 200, 225, 250, 280,
										...
										1020, 1080, 1140, 1200, 1260, 1280, 1300, 1400, 1500};
		...
		//Returns:	Nothing
		//Throws:	
        //Modified: 24/07/2006: Return command instead of answerstring
		//------------------------------------------------------------------------------------
		...
		public string TurnAndMove(float fDistance, float radAngle)
		{
			 ...
			 *are needed, therefore we also conver this =/ */
				...
				{
					FileMode fMode;
					if(System.IO.File.Exists(@"\errorparsed.txt"))
