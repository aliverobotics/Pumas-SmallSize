...
#define SetFactListChanged(a) EnvSetFactListChanged(GetCurrentEnvironment(),a)
   ...
   LOCALE BOOLEAN                        EnvGetFactSlot(void *,void *,char *,DATA_OBJECT *);
   LOCALE void                           PrintFactWithIdentifier(void *,char *,struct fact *);
   LOCALE void                           PrintFact(void *,char *,struct fact *);
   LOCALE void                           PrintFactIdentifierInLongForm(void *,char *,void *);
   LOCALE BOOLEAN                        EnvRetract(void *,void *);
   ...
   LOCALE BOOLEAN                        EnvPutFactSlot(void *,void *,char *,DATA_OBJECT *);
   LOCALE BOOLEAN                        EnvAssignFactSlotDefaults(void *,void *);
   LOCALE BOOLEAN                        CopyFactSlotValues(void *,void *,void *);
