...
static long InstancesSaveCommandParser(void *,char *,long (*)(void *,char *,int,
                                                   EXPRESSION *,BOOLEAN));
static DATA_OBJECT *ProcessSaveClassList(void *,char *,EXPRESSION *,int,BOOLEAN);
static void ReturnSaveClassList(void *,DATA_OBJECT *);
static long SaveOrMarkInstances(void *,void *,int,DATA_OBJECT *,BOOLEAN,BOOLEAN,
...
#if BLOAD_INSTANCES
static BOOLEAN VerifyBinaryHeader(void *,char *);
...
globle long EnvBinarySaveInstances(
  ...
  BOOLEAN inheritFlag)
  {
   ...
   if ((bsaveFP = GenOpen(file,"wb")) == NULL)
     {
...
static long InstancesSaveCommandParser(
  void *theEnv,
  char *functionName,
  long (*saveFunction)(void *,char *,int,EXPRESSION *,BOOLEAN))
  {
   char *fileFound;
   DATA_OBJECT temp;
