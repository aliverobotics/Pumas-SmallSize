...
/***************************************/
   ...
   static BOOLEAN                 GetDefglobalValue2(void *,void *,DATA_OBJECT_PTR);
...
#pragma argsused
#endif
globle BOOLEAN EnvIsDefglobalDeletable(
  void *theEnv,
  void *ptr)
  {
#if MAC_MCW || IBM_MCW || MAC_XCD
...
/*   global variable in the supplied DATA_OBJECT.           */
/************************************************************/
globle BOOLEAN EnvGetDefglobalValue(
  void *theEnv,
  char *variableName,
  DATA_OBJECT_PTR vPtr)
  {
...
/****************************************************************/
globle BOOLEAN EnvSetDefglobalValue(
  void *theEnv,
  char *variableName,
  DATA_OBJECT_PTR vPtr)
  {
